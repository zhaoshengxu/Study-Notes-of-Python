...
"定义方法get_dir_glob(folde),该函数返回folder文件夹的文件列表。"
...
f = get_dir_glob(r'C:\Program Files\Sublime Text 3\practice\*')
for x in f:
    print(x)
"""
...
"定义方法get_dir_listdir(folder),该函数返回folder文件夹的文件列表。"
...
print(get_dir_listdir(r'E:\eLibrary\#老王Python\基础'))
